exports.setup = function (app, controller, io){
  ...
  app.get('/js/views/AppView.js', function (req, res){ res.sendfile('js/views/AppView.js'); });
  app.get('/js/views/LoginView.js', function (req, res){ res.sendfile('js/views/LoginView.js'); });
  app.get('/js/views/SignupView.js', function (req, res){ res.sendfile('js/views/SignupView.js'); });
  app.get('/js/views/ProfileView.js', function (req, res){ res.sendfile('js/views/ProfileView.js'); });
  app.get('/js/views/JoinView.js', function (req, res){ res.sendfile('js/views/JoinView.js'); });
  app.get('/js/views/CreateView.js', function (req, res){ res.sendfile('js/views/CreateView.js'); });
  app.get('/js/views/HomeView.js', function (req, res){ res.sendfile('js/views/HomeView.js'); });
  app.get('/js/views/AdminView.js', function (req, res){ res.sendfile('js/views/AdminView.js'); });
